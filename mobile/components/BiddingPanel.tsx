...
const styles = StyleSheet.create({
  ...
  logCard: { backgroundColor: '#E6FAF5', borderRadius: Radius.md, padding: Spacing.sm, marginBottom: Spacing.sm, borderWidth: 1, borderColor: Colors.primaryDim },
  ...
  bidCardRecommended: { borderColor: Colors.primary, backgroundColor: '#E6FAF5' },
